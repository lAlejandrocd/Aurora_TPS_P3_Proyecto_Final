				...
				<div class="row">
						...
						<div class="col-md-4 mx-auto">
								...
								<div class="card card-body">
										...
										<form action="editar_usuarios.php" method= 'POST' class="table table-dark"> 
											...
											<button class="btn btn-success" name="actualizar_dato" >
											...
											<a href="ver_usuarios.php"><button class="btn btn-success" name="Regresar">Regresar</button></a>
