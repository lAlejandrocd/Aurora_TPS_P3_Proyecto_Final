        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
              <div class="site-logo">
                <a href="index.php" class="js-logo-clone">AURORA</a>
              </div>
            </div>
            ...
            <div class="col-6 col-md-4 order-3 order-md-3 text-right">
              <div class="site-top-icons">
                <ul>
                  <li>
                    <a href="../Conexion_BD/Usuario/cerrar_sesion.php" class="site-cart">
                      <span class="icon icon-close"></span>               
                    </a>
                  </li> 
                  <li>
                  <li><a href="../Conexion_BD/Usuario/datos.php"><span class="icon icon-person"></span></a></li>
                  <li>
